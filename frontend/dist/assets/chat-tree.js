...
// 依赖：chat-state.js（webRunning, currentSessionId, expandedParts, subtaskSummaries, detailMessageCache）、
//       chat-service.js（ocApi）、chat-mobile.js（isMobileTreeMode, closeMobileTree）、utils.js（escapeHtml, showToast）
// ============================================================
